...
from .models import User,CreatePost,SavedPost,UserProfile
...
class CreatePostSerializer(serializers.ModelSerializer):
    class Meta:
        model = CreatePost
        fields = ['id','username','caption','post','location','tags','created_at','likes']
...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model= UserProfile
        fields = ['id','username','name','bio','profilePic']